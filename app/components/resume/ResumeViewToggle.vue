...
<template>
  <div
    class="flex items-center justify-center gap-1 sm:gap-2 p-1 bg-gray-100 dark:bg-gray-800 rounded-lg"
    role="tablist"
    :aria-label="$t('resume.viewToggleAria')"
  >
    <button
      :class="[
    ...
    >
      <span class="flex items-center gap-1.5 sm:gap-2">
        ...
        <span>{{ $t('resume.viewMode.industry') }}</span>
      </span>
    </button>
    <button
      :class="[
    ...
    >
      <span class="flex items-center gap-1.5 sm:gap-2">
        ...
        <span>{{ $t('resume.viewMode.research') }}</span>
      </span>
    </button>
  </div>
</template>
