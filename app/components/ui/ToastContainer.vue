    ...
    >
      <TransitionGroup name="toast">
        <div
          ...
          :key="toast.id"
          class="pointer-events-auto flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg backdrop-blur-sm max-w-sm"
          :class="{
            'bg-green-500/90 text-white': toast.type === 'success',
            'bg-red-500/90 text-white': toast.type === 'error',
            'bg-gray-800/90 text-white dark:bg-gray-700/90': toast.type === 'info'
          }"
          role="alert"
        >
          <svg
